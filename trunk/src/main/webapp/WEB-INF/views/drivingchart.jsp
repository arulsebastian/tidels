    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
   	...
   	<c:forEach items="${mapDriving}" var="driving">
        var j = 0;
        data.addRows(1); 
        data.setCell(i, j, "${driving.value.fromlocation}"+"-"+"${driving.value.tolocation}");
        j = j+1;
        data.setCell(i, j, "${driving.value.hours}");
        i = i+1;
        </c:forEach>
...
<h2>
 ...
 <h3>
                <a href="/tidels/driving/${timePeriod}/">Dashboard&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                <a href="/tidels/driving/${timePeriod}chart/"  class="active getDefoult" >Chart&nbsp&nbsp&nbsp&nbsp&nbsp</a>
</h3>
<br> 
